...
#安装包下载地址
INSTALLPACK=https://github.com/batting/serverspeeder/blob/test/91yunserverspeeder.tar.gz?raw=true
#判断版本支持情况的地址
CHECKSYSTEM=https://github.com/batting/serverspeeder/blob/master/serverspeederbin.txt
#bin下载地址
